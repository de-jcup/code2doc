...
* under the License.*/
package de.jcup.code2doc.demo.dao;

import static de.jcup.code2doc.demo.documentation.architecture.PersistenceConcept.*;
...
import de.jcup.code2doc.demo.documentation.usecase.entries.UC_02_SHOW_ENTRY_LIST;
import de.jcup.code2doc.demo.documentation.usecase.entries.UC_03_CREATE_NEW_ENTRY;
import de.jcup.code2doc.demo.documentation.usecase.entries.UC_04_DELETE_ENTRY;
import de.jcup.code2doc.demo.documentation.usecase.entries.UC_05_EDIT_ENTRY;
import de.jcup.code2doc.demo.entity.Entry;
