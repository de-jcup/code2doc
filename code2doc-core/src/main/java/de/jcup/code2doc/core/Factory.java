...
public class Factory {
	...
	/**
	 * Creates a decorator for decoration when code2doc is used in internal way - with API inside projects - 
	 * all information is decorated to specification by this decorator.
	...
	/**
	 * Creates an empty specification - can be used for specifications form outside or inside approach 
	...
	/**
	 * Creates specification for inside approach - means fully decorated.
	 * Only for convenience - could also be done via empty specificiaton and 
	 * decorators
