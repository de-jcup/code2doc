...
public class TransformerTest {
	...
	@Test
	public void buildInnerClassName() {
		assertEquals("de.jcup.test.bla1$bla2", transformer.buildInnerClassName("de.jcup.test.bla1.bla2"));
	}

	@Test
	public void test_transform_to_class() {
		Class<?> clazz = transformer.transformToClass(getClass().getName() + ".InnerTestClass1.InnerSubTestClass1_1");
		assertNotNull(clazz);
		assertEquals(de.jcup.code2doc.core.internal.util.TransformerTest.InnerTestClass1.InnerSubTestClass1_1.class, clazz);
	}
	...
	private class InnerTestClass1 {

		private class InnerSubTestClass1_1 {
